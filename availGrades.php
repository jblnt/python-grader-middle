<?php
	...
	//backend checking
	$payload=array("available_grades" => $_POST["status"]);

	//$backURL="https://web.njit.edu/~job5/test/exam_grades.php";
	$backURL="https://web.njit.edu/~jcn22/displayGradeStatus.php";
    ...
    foreach($exam_nums as $value){
        $secondary_arr=array();
        $secondary_arr["examNo"]=trim($value);
        $secondary_arr["username"]=$_POST["username"];
        array_push($formatted_arr, $secondary_arr);
    }
    
    echo json_encode($formatted_arr);
?>
